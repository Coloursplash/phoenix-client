...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    public void renderItemAndEffectIntoGUI(ItemStack p_175042_1_, int p_175042_2_, int p_175042_3_)
    {
    ...
    public void func_180450_b(final ItemStack p_180450_1_, int p_180450_2_, int p_180450_3_)
    {
        if (p_180450_1_ != null)
        {
            ...
            try
            {
                this.renderItemAndEffectIntoGUI(p_180450_1_, p_180450_2_, p_180450_3_);
            }
