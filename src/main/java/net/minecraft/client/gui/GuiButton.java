...
public class GuiButton extends Gui
{
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            Gui.drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, 0x44000000);
            this.mouseDragged(mc, mouseX, mouseY);
            int var6 = Color.LIGHT_GRAY.getRGB();
