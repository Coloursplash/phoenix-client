...
import phoenixclient.gui.GuiClientMenu;
...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(1000, this.width / 2 - 100, this.height / 4 + 72 + var1, 200, 20, I18n.format("Phoenix Options", new Object[0])));
        GuiButton guiButton;
        this.buttonList.add(guiButton = new GuiButton(7, this.width / 2 + 2, this.height / 4 + 96 + var1, 98, 20, I18n.format("menu.shareToLan", new Object[0])));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            ...
            case 2:
                this.mc.displayGuiScreen(new GuiClientMenu(this));
                break;
