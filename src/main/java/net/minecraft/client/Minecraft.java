...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private static final ResourceLocation locationPhoenixPng = new ResourceLocation("phoenixclient/textures/gui/splashscreen.png");
    ...
    private ResourceLocation phoenixLogo;
    ...
    private void startGame() throws LWJGLException
    {
        ...
        this.renderEngine.deleteTexture(this.phoenixLogo);
        this.phoenixLogo = null;
    ...
    private void func_175609_am() throws LWJGLException
    {
        ...
        Display.setTitle("Phoenix Client (v" + Client.getVersion() + ")");
    ...
    private void func_175594_ao()
    {
        ...
        if (var1 != Util.EnumOS.OSX)
        {
            ...
            try
            {
                icon = this.mcDefaultResourcePack.func_152780_c(new ResourceLocation("icons/icon_16x16.png"));
                System.out.println(icon);

                if (icon != null)
                {
                    Display.setIcon(new ByteBuffer[] {this.readImageToBuffer(icon)});
                }
            }
    ...
    private void func_180510_a(TextureManager p_180510_1_)
    {
        ...
        try
        {
            var5 = this.mcDefaultResourcePack.getInputStream(locationPhoenixPng);
            this.phoenixLogo = p_180510_1_.getDynamicTextureLocation("logo", new DynamicTexture(ImageIO.read(var5)));
            p_180510_1_.bindTexture(this.phoenixLogo);
        }
        catch (IOException var12)
        {
            logger.error("Unable to load logo: " + locationPhoenixPng, var12);
        }
        finally
        {
